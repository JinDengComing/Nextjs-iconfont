    ...
    <div className="min-h-screen bg-background text-foreground">
      ...
      <section className="bg-gradient-to-br from-blue-600 to-indigo-700 text-white py-16">
        <div className="container mx-auto px-4">
          <h1 className="text-4xl md:text-5xl font-bold mb-4 animate-fade-in">我的作品集</h1>
          <p className="text-xl text-blue-100 animate-fade-in delay-100">
          ...
          {projects.length > 0 ? (
            <>
              ...
              <div className="relative mb-8 ">
                <div
                  ref={tabRef}
                  className={`flex gap-4 pb-2 border-b border-gray-200 dark:border-gray-700 transition-all duration-300 ${isTabFixed ? 'fixed  left-0 right-0 z-40 bg-background shadow-md py-4' : 'mb-8'}`}
                  style={{
                    paddingLeft: '1rem',
                    paddingRight: '1rem',
                    maxWidth: '1200px',
                ...
                >
                  ...
                  <button
                    ...
                    className={`px-4 py-2 rounded-t-lg font-medium transition-colors ${activeTab === 'mobile' ? 'text-blue-600 dark:text-blue-400 border-b-2 border-blue-600 dark:border-blue-400' : 'text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-gray-100'}`}
                  >
                    移动端
                  </button>
                </div>
              ...
              >
                {projects.filter(project => {
                  ...
                  if (activeTab === 'pc' && project.tags.includes('pc')) return true;
                  if (activeTab === 'mobile' && project.tags.includes('mobile')) return true;
                  return false;
                }).map((project, index) => (
                  <div key={project.id} className="bg-white dark:bg-gray-800 rounded-xl shadow-lg overflow-hidden border border-gray-100 dark:border-gray-700 transition-shadow hover:shadow-xl animate-fade-in"
                    style={{
                      ...(theme == 'light' ? { backgroundColor: '#f9f9f9', border: '1px solid #e5e5e5' } : {}),
